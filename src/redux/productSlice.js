...
initialState: [
  {
    ...
    description:
      "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Soluta dolorum libero fugit eveniet officiis repudiandae at perferendis accusantium velit vero.",
    stock: 20,
    price: 2000000,
    product_type: "Shoes",
...
reducers: {
    addToCartProduct: (state, payload) => {
        ...
        if (findProduct.stock === 0) {
            alert ("this product is empty!!!!!!!11")
            return
        }
        state?.map(s => {
